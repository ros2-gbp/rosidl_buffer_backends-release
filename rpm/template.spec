...
%global pkg_name cuda_buffer_backend_msgs
%global normalized_pkg_name %{lua:return (string.gsub(rpm.expand('%{pkg_name}'), '_', '-'))}

Name:           ros-lyrical-cuda-buffer-backend-msgs
Version:        0.1.2
Release:        1%{?dist}
...
%description
CUDA buffer descriptor messages for rosidl::Buffer backend serialization.
